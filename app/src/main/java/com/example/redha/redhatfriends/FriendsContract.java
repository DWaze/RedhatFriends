...
public class FriendsContract {
    ...
    public static final String CONTENT_AUTHORITY="com.example.redha.redhatfriends.provider";
    ...
    public static class Friends implements FriendsColumns,BaseColumns{
        ...
        public static final String COTENT_TYPE = "vnd.android.cursor.dir/vnd."+CONTENT_AUTHORITY+".friends";
        public static final String COTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd."+CONTENT_AUTHORITY+".friends";
