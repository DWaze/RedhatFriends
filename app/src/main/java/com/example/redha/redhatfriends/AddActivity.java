...
public class AddActivity extends FragmentActivity {
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isValid()){
                    ...
                    Toast.makeText(getApplicationContext(),"Please ensure you have entered a valide data!",Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private boolean isValid(){
        if(mNameTextView.getText().toString().length()==0 || mPhoneTextView.getText().toString().length()==0 ||
